...
abstract class GithubIntegrationSpec extends IntegrationSpec {
    ...
    @Shared
    def testRepositoryName = "${testUserName}/atlas-node-release-integration" + uniquePostfix()
    ...
    def createTestRepo() {
        ...
        builder.description("Integration test repo for wooga/atlas-node-release")
